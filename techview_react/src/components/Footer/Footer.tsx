...
const Footer = () => {
  ...
  return (
    <footer className="relative min-h-[50vh] overflow-hidden debug-outline" style={{backgroundColor: '#1a1a1a'}}>
      {/* Decorative elements */}
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 py-12 sm:py-16 lg:py-20 debug-outline-blue">
